...
public class film_textDAO { 

	public   String tableName="film_text";
	public String[] JavaDataTypes={"int","boolean","long","float","double","String","Date","Timestamp","Time"};
	public String[] colNames={"film_id","title","description"};
	...
	public String[] colTypes= {"int","String","String"};
	 ...
	 *
	 */
	public film_textDTO[] select(String str){
		...
		film_textDTO[] film_textValues = new film_textDTO[counter];
		counter=0;
		for(Entity u1:pq.asIterable()){
			film_textValues[counter]= new film_textDTO();
			String film_id = u1.getProperty("film_id").toString();
			film_textValues[counter].setfilm_id(Integer.parseInt(performOper(film_id)));
			String title = u1.getProperty("title").toString();
			film_textValues[counter].settitle((performOper(title)));
			String description = u1.getProperty("description").toString();
			film_textValues[counter].setdescription((performOper(description)));
			counter++;
		}
		return film_textValues;
	}
	/*
	 * <p>
	...
	public void update(String str){
		...
		for(Entity u1:pq.asIterable()){
			Key k = u1.getKey();
			String t= k.getName();
			Entity film_text = new Entity(tableName,t);
			film_text.setProperty("film_id",u1.getProperty("film_id"));
			film_text.setProperty("title",u1.getProperty("title"));
			film_text.setProperty("description",u1.getProperty("description"));
			film_text = UpdateSetQuery(str,film_text);
			ds.put(film_text);
		}
	}
	...
	Entity film_text = new Entity("film_text",performOper(eachValue.get(matchPrimary)));
	...
	break;
			...
			if(colTypes[i] .equals("int")){
				film_text.setProperty(colNames[i], Integer.parseInt(performOper(eachValue.get(i))));
			}
			if(colTypes[i] .equals("boolean")){
				film_text.setProperty(colNames[i], Boolean.parseBoolean(performOper(eachValue.get(i))));
			}
			if(colTypes[i] .equals("long")){
				film_text.setProperty(colNames[i], Long.parseLong(performOper(eachValue.get(i))));
			}
			if(colTypes[i] .equals("float")){
				film_text.setProperty(colNames[i], Float.parseFloat(performOper(eachValue.get(i))));
			}
			if(colTypes[i] .equals("double")){
				film_text.setProperty(colNames[i], Double.parseDouble(performOper(eachValue.get(i))));
			}
			if(colTypes[i] .equals("String")){
				film_text.setProperty(colNames[i], performOper(eachValue.get(i)));
			}
			if(colTypes[i] .equals("long")){
				film_text.setProperty(colNames[i], Long.parseLong(performOper(eachValue.get(i))));
			}
	 ...
	 *
	 */
	public Entity UpdateSetQuery(String str,Entity film_text){
		...
		for(int i=0;i<eachSet.length;i++){
			...
			if(colTypes[indexFoundColumn] .equals("int")){
				film_text.setProperty(colNames[indexFoundColumn], Integer.parseInt(performOper(nameValue[1])));
			}
			if(colTypes[indexFoundColumn] .equals("boolean")){
				film_text.setProperty(colNames[indexFoundColumn], Boolean.parseBoolean(performOper(nameValue[1])));
			}
			if(colTypes[indexFoundColumn] .equals("long")){
				film_text.setProperty(colNames[indexFoundColumn], Long.parseLong(performOper(nameValue[1])));
			}
			if(colTypes[indexFoundColumn] .equals("float")){
				film_text.setProperty(colNames[indexFoundColumn], Float.parseFloat(performOper(nameValue[1])));
			}
			if(colTypes[indexFoundColumn] .equals("double")){
				film_text.setProperty(colNames[indexFoundColumn], Double.parseDouble(performOper(nameValue[1])));
			}
			if(colTypes[indexFoundColumn] .equals("String")){
				film_text.setProperty(colNames[indexFoundColumn], (performOper(nameValue[1])));
			}
			if(colTypes[indexFoundColumn] .equals("Date")){
				film_text.setProperty(colNames[indexFoundColumn], (performOper(nameValue[1])));
			}
			if(colTypes[indexFoundColumn] .equals("Timestamp")){
				film_text.setProperty(colNames[indexFoundColumn], StringToTimestamp(performOper(nameValue[1])));
			}
